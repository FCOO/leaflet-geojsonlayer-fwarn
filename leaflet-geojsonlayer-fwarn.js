                ...
                layer.on({
                    click: function (evt) {
                        if (feature.properties.language === 'da') {
                            ...
                            var warning_template = '<p>Varsel starttid: {warningStartTime} UTC</p><p>Varsel sluttid: {warningEndTime} UTC</p><hr/>';
                            ...
                            var warning_template = '<p>Warning start time: {warningStartTime} UTC</p><p>Warning end time: {warningEndTime} UTC</p><hr/>';
